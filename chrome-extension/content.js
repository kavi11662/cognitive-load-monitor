...
class CognitiveLoadMonitor {
  ...
  updateScoreDisplay() {
    ...
    if (scoreEmoji) scoreEmoji.textContent = emoji;
    
    const scoreLabel = document.getElementById('clm-score-label');
    if (scoreLabel) scoreLabel.textContent = label;
    
    const scoreValue = document.getElementById('clm-score-value');
  ...
  updateStatusUI(status, text) {
    ...
    localStorage.setItem('connectionStatus', storageStatus);
  }
